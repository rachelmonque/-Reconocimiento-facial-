...
El siguiente codigo tiene la funcionalidad de reconocer caracteristicas faciales mediante imagenes, se necesita un repositorio de microsoft azure e importar las siguientes librerias:
...
A continuacion el código:
   ...
   Esta lista vacia lo que hace es guardar la cantidad de veces que se ejecuto un ejercicio.
   
    history_list = []


   Esta funcion lo que hace es mostrar un rectangulo en el rostro de la persona.
   ...
   Seguidamente hay 2 diferentes ordenamientos para listas:
   
   El primer ordenamiento es el de bubble_ordering este lo que hace es ordenar las listas con sublistas en su posición descrita por un rango de 10
   
   Arguments: list {list} -- Lista con sublistas que contienen la edad y el sexo
   ...
   Return: [menores,pivote,mayor] -- Devuelve la lista con sublistas
   ...
   El siguiente ordenamiento lo que hace es ordenar los géneros y las edades de las caras en una lista con sublistas
   
   Arguments: list{list} -- Lista con sublistas que contienen géneros y edades
  
   Return: list1 - Devuelve la lista con sublistas que contienen géneros y edades
   ...
   Esta funcion obtiene las caracteristicas de las personas de una imagen.
   
   Arguments: picture {string} -- es la imagen
   
   Return: una lista con información sobre las personas  
   ...
   Muestra una lista con información sobre las personas
   ...
   Indica el número de caras en la imagen y la edad asociada a cada cara.
   ...
   Muestra una lista con todas las edades de las personas e indica quién es la persona de mayor edad.
   ...
   Ordenar las sublistas de una lista en un rango de 10 
   
   Arguments: list {list} -- Lista con sublistas que contienen edades y géneros
   ...
   arguments: analysis {lista} -- es una lista con la información de las personas
   ...
   Extrae los datos más altos de la lista
   
   Arguments: lista {list}-- lista con sublista que contiene el faceId, la edad y el género 
   ...
   Ordena la lista con sublistas de menor a mayor
   
   Arguments: lista {list} -- lista con sublistas que contienen el faceId, la edad y el género
   ...
   Crea una lista con sublistas para mostrar la edad y el sexo de las caras en las imágenes.
   ...
   Muestra la edad de todas las personas presentes en una imagen en
   ...
   Crea una lista con sublistas que muestran la edad y el género de las caras en las imágenes.
   
   Muestra las personas separadas por género en sublistas, el género masculino va primero, y las sublistas 
   se ordenan utilizando el método de ordenación quicksort.
   
   Argumentos: análisis {lista} -- es una lista con la información de las personas 
   ...
   Muestra el faceId y el color de pelo más predominante de cada persona.
   ...
   Muestra la caraId y la emoción más predominante de una persona.
   ...
   Muestra los accesorios que lleva una persona.
   
   Argumentos: picture {string} -- es la imagen
   ...
   Muestra la imagen con un rectángulo en las caras
   ...
   Muestra la persona que tiene la media de felicidad más alta pero menor que la media de edad de las personas 
   ...
   Muestra a la persona que tiene la media más alta de felicidad y que está por debajo de la media de edad de las personas de la foto.
   ...
   Muestra un rectángulo las caras de las personas con más barba patillas y bigote.
   ...
   Muestra a las mujeres que llevan gafas 
   ...
   Muestra a la persona que tiene el pelo más rubio y es hombre  
   ...
   Propone dos consultas que creemos importantes realizar de la información obtenida
   ...
   Muestra el más joven de todas las edades contenidas en la lista
   ...
   Muestra el porcentaje de una persona de emoción neutral.
   ...
   Guarda cada consulta que se hace en una lista para mantener un historial 
   
   Argumentos: analysis {lista} -- es una lista con la información de las personas
   ...
   Realiza un informe de consulta con 5 imágenes que muestran más de 5 
   ...
   Por ultimo ultimo tenemos la funcion multiproceso, lo que hace es optimizar un proceso a realizar
